...
const pushLeadWhatsapp = (source: string) => {
  window.dataLayer = window.dataLayer || [];
  window.dataLayer.push({ event: "lead_whatsapp", wa_source: source });
};
