...
export const FloatingWhatsApp = () => (
  <a href={WA_LINK_DEFAULT} target="_blank" rel="noopener noreferrer"
    ...
    <span className="absolute right-[64px] text-sm px-3 py-1.5 rounded-full opacity-0 group-hover:opacity-100 transition-opacity whitespace-nowrap pointer-events-none"
