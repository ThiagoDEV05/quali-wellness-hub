...
const WA_LINK_DEFAULT = waLink("Ola! Vim pelo site e quero agendar uma avaliacao gratuita.");
...
export const GoldCTA = ({ text, message, className = "" }: { text: string; message?: string; className?: string }) => {
  ...
  return (
    <a href={href} target="_blank" rel="noopener noreferrer" className={`qs-btn-gold ${className}`} onClick={() => pushLeadWhatsapp("cta_button")}>
      {text}
    </a>
  );
};
